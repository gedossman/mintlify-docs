...
That's it. Your coding agent installs the toolkit, scans your codebase, extracts an `interf.yaml` onboarding contract declaring every dependency, and previews what rollout looks like at BlackRock — all in one prompt.
