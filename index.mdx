...
description: "Interf is the unified interface for agent onboarding in enterprise. Create your agent's onboarding contract, preview enterprise rollouts, and publish to the registry — so enterprises can self-prepare and your agent can self-onboard."
---
...
That's it. Your coding agent installs the toolkit, scans your codebase, extracts an `interf.yaml` onboarding contract declaring every dependency, and previews what rollout looks like at Nike — all in one prompt.
